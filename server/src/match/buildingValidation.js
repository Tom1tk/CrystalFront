...
export function validatePlacement(x, y, buildingDef, entities, resourceNodes, playerColor, crystals, playerId, mapWidth, mapHeight) {
...
export function findCrystalByColor(entities, color) {
...
export function getCrystalsForPlayer(entities, playerId) {
    return Array.from(entities.values()).filter((e) => e.type === "crystal" && e.ownerId === playerId);
}
